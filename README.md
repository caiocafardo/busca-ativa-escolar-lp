...
Página inicial, construida com html e css e js, que auxilia na condução dos atores envolvidos, informa e hospeda os materiais de apoio para utilização do sistema.
...
## Doc
Toda documentação da aplicação está na pasta [doc](https://github.com/lqdi/busca-ativa-escolar-api/tree/master/doc) do repositório da api do sistema. 
